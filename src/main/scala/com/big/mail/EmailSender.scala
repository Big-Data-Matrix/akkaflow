 ...
 * Email发送actor
 */
class EmailSender(hostName: String, portOpt: Option[Int], auth:Boolean, account: String, pwd: String, charset: String, isEnabled: Boolean) extends DaemonActor {
